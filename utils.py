...
def load_config(dataset, args):
    if dataset == 'Epilepsy':
        from configs.Epilepsy_hyper_param import Param as config
        configs = config()
    elif dataset == 'HAR':
        ...
        from configs.ISRUC_hyper_param import Param as config
        configs = config()
    elif dataset == 'RoadBank'  or dataset == "Bridge" :
        from configs.RoadBank_Configs import Param as config
        configs = config()
    elif "UEA" in dataset:
        from configs.UEA_hyper_param import Param as config
        configs = config()
    elif "UCR" in dataset:
        from configs.UCR_hyper_param import Param as config
        configs = config()
