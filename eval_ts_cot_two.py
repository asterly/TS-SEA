...
if __name__ == '__main__':
    ...
    experiment_log_dir = os.path.join("exp_logs", "exp_1p", args.dataset,args.backbone_type)
    ...
    if args.backbone_type == 'TS_CoT':
        ...
        if args.dataset == 'ISRUC':
            train_data, train_labels, test_data, test_labels = datautils.load_isruc_two_view()
    else:
